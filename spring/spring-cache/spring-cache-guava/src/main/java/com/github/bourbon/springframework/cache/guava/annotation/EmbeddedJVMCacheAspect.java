...
import com.github.bourbon.cache.guava.annotation.EmbeddedJVMCache;
...
public class EmbeddedJVMCacheAspect extends AbstractCacheEmbeddedValueConverter implements GuavaCacheAspect {

    private Map<String, Cache<Object, Object>> map = MapUtils.newConcurrentHashMap();
    ...
    Cache<Object, Object> getCache(Method method, EmbeddedJVMCache cache, Function<Object, Object> function) {
        return map.computeIfAbsent(CacheAspect.getKey(method),
                k -> cacheAdapter.getCache(new CacheParamInfo<>()
                        ...
                        .setConcurrencyLevel(getInteger(cache.concurrencyLevel()))
